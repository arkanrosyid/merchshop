...
<html lang="en">
  ...
  <div class="container">
        ...
        <div>
        <a href="account_pembeli.php"><i class="fas fa-arrow-circle-left"></i></a>
    </div>
...
if(isset($_POST['simpan'])){
    ...
    $conn -> query ("UPDATE `user` SET `file`='$foto',`file_name`='$file_name',`file_type`='$file_type',`file_size`='$file_size'  WHERE email = '$email' ");
